...
<head>
    ...
    <title>Student Portal — Gaurangi Technologies</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .form-control:focus{border-color:#6d28d9;box-shadow:0 0 0 3px rgba(109,40,217,.12);background:#fff;outline:none;}
            ...
            <form method="POST" action="{{ route('student.login.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="student_uid"
                           ...
                           placeholder="e.g. STU-2024-001" required autofocus>
                </div>
