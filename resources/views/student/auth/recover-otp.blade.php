...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .email-chip{display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.2);border-radius:8px;padding:6px 12px;font-size:12px;color:#fff;font-weight:600;margin-top:8px;word-break:break-all;flex-wrap:wrap;}
        ...
        .otp-input:focus{border-color:#2563EB;box-shadow:0 0 0 3px rgba(37,99,235,.12);background:#fff;outline:none;}
        ...
        .resend-btn{font-size:12px;color:#2563EB;background:none;border:none;padding:0;cursor:pointer;font-weight:600;}
...
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="card-head">
            ...
            <p style="margin-bottom:6px;">OTP sent to your registered email</p>
            <div class="email-chip">
                <i class="bi bi-envelope-fill"></i>
                {{ substr($student->email, 0, 3) }}***{{ '@'.explode('@', $student->email)[1] }}
            </div>
        </div>
        ...
        <div class="card-body-wrap">
            ...
            <form method="POST" action="{{ route('student.recover.otp.verify') }}">
                @csrf
                <div class="mb-4">
        ...
        <div class="card-foot">
            <a href="{{ route('student.recover') }}" class="back-link">
                <i class="bi bi-arrow-left"></i> Start over
            </a>
            <form method="POST" action="{{ route('student.recover.otp.resend') }}" class="mb-0">
                @csrf
