...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('group_admin.institutes.show', $institute->id) }}" class="text-decoration-none">{{ $institute->name }}</a></li>
    <li class="breadcrumb-item active">Edit</li>
@endsection

@section('content')

<a href="{{ route('group_admin.institutes.show', $institute->id) }}" class="btn btn-outline-secondary btn-sm mb-3">
    <i class="bi bi-arrow-left me-1"></i> Back to Profile
</a>

<form method="POST" action="{{ route('group_admin.institutes.update', $institute->id) }}" enctype="multipart/form-data">
@csrf
@method('PUT')
        ...
        <div class="row g-3">
            ...
            <div class="col-md-2">
                <label class="form-label fw-semibold small">
                    Short Name
                    <span class="text-muted d-block" style="font-size:10px;font-weight:400;">Cannot be changed</span>
                </label>
            ...
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" value="{{ $institute->student_limit }}" disabled readonly>
                <small class="text-muted">Set by your group</small>
            </div>
            <div class="col-md-3">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <small class="text-muted">This is the owner's login ID — changing it changes their login too.</small>
            </div>
            <div class="col-md-4">
...
<div class="alert alert-info small">
    Subscription dates are governed by your group's settings and can't be edited here — contact the platform administrator to change them.
</div>
...
<div class="d-flex gap-2">
    ...
    <a href="{{ route('group_admin.institutes.show', $institute->id) }}" class="btn btn-outline-secondary">Cancel</a>
</div>
