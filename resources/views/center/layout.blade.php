...
<div class="sidebar">
    ...
    <ul class="nav flex-column mt-2">
        ...
        @php
            ...
            $canQuick = !$canAdmit ? false : ($authGuard === 'center' ? $authUser->canUseQuickAdmissionForm() : true);
            $canFull  = !$canAdmit ? false : ($authGuard === 'center' ? $authUser->canUseFullAdmissionForm() : ($authGuard === 'staff'));
        @endphp
        @if($canAdmit)
        ...
        @if($authGuard === 'center')
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('center.students.search') ? 'active' : '' }}"
        ...
        @if($authGuard === 'center')
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('center.fee.index') ? 'active' : '' }}"
        ...
        {{-- Reports --}}
        @if($authGuard === 'center' && $authUser->canDownloadReports())
