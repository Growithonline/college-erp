...
<head>
    ...
    <title>OTP Verification — Center</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .bg-glow1{position:fixed;z-index:2;pointer-events:none;width:500px;height:500px;border-radius:50%;background:radial-gradient(circle,rgba(15,76,129,.55) 0%,transparent 70%);top:-150px;left:-100px;animation:floatOrb 8s ease-in-out infinite;}
        .bg-glow2{position:fixed;z-index:2;pointer-events:none;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(24,95,165,.4) 0%,transparent 70%);bottom:-120px;right:-80px;animation:floatOrb 10s ease-in-out infinite reverse;}
        ...
        .card-head{background:linear-gradient(135deg,#0d3b75 0%,#185FA5 60%,#1a7abf 100%);padding:28px 28px 22px;position:relative;overflow:hidden;}
        ...
        .otp-input:focus{border-color:#185FA5;box-shadow:0 0 0 3px rgba(24,95,165,.12);background:#fff;outline:none;}
        .otp-input.is-invalid{border-color:#ef4444;}
        .btn-submit{height:46px;border-radius:10px;font-size:14px;font-weight:600;background:linear-gradient(135deg,#0d3b75,#185FA5);border:none;color:#fff;letter-spacing:.02em;transition:all .18s ease;width:100%;}
        .btn-submit:hover{background:linear-gradient(135deg,#0a2d5a,#124e8e);box-shadow:0 6px 20px rgba(24,95,165,.35);transform:translateY(-1px);}
        ...
        .resend-btn{font-size:12px;color:#185FA5;background:none;border:none;padding:0;cursor:pointer;font-weight:600;}
        .resend-btn:hover{color:#0d3b75;}
        ...
        .alert-success-box{background:#eff6ff;color:#1d4ed8;border-left:3px solid #3b82f6;}
    </style>
</head>
<body>
...
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="card-head">
            ...
            <div class="email-chip"><i class="bi bi-envelope-fill"></i>{{ $center->email }}</div>
            @if($center->mobile)
        ...
        <div class="card-body-wrap">
            ...
            <form method="POST" action="{{ route('center.otp.verify') }}">
                @csrf
                <div class="mb-4">
        ...
        <div class="card-foot">
            <a href="{{ route('center.login') }}" class="back-link">
                <i class="bi bi-arrow-left"></i> Back to login
            </a>
            <div class="d-flex align-items-center gap-3">
                <form method="POST" action="{{ route('center.otp.resend') }}" class="mb-0">
                    @csrf
