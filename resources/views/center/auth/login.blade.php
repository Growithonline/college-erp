...
<head>
    ...
    <style>
        ...
        .top-bar{height:4px;background:#185FA5;}
        .brand-circle{width:52px;height:52px;border-radius:50%;background:#185FA520;display:flex;align-items:center;justify-content:center;font-size:22px;color:#185FA5;margin:0 auto 12px;}
        .form-control{border-radius:8px;height:44px;border:1.5px solid #e2e8f0;font-size:14px;}
        .form-control:focus{border-color:#185FA5;box-shadow:0 0 0 3px #185FA525;}
        .btn-submit{height:46px;border-radius:8px;font-size:15px;font-weight:500;background:#185FA5;border:none;letter-spacing:.01em;transition:background .18s ease,box-shadow .18s ease,transform .15s ease;}
        .btn-submit:hover{background:#124e8e;box-shadow:0 4px 14px rgba(24,95,165,.35);transform:translateY(-1px);}
...
<div class="card">
    ...
    <div class="p-4 p-md-5">
        ...
        <div class="text-center mb-4">
            <div class="brand-circle"><i class="bi bi-building"></i></div>
            <h5 class="fw-bold mb-1" style="color:#1e293b;">Center Login</h5>
            <p class="text-muted mb-0" style="font-size:13px;">Access your center portal</p>
        </div>
