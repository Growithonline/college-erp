...
<head>
    ...
    <title>Center Login — Gaurangi Technologies</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .form-control:focus{border-color:#185FA5;box-shadow:0 0 0 3px rgba(24,95,165,.12);background:#fff;outline:none;}
...
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="card-head">
            ...
            <h5>Center Login</h5>
            <p>Access your study center portal</p>
        </div>
        ...
        <div class="card-body-wrap">
            ...
            <form method="POST" action="{{ route('center.login.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="center_uid"
                           class="form-control @error('center_uid') is-invalid @enderror"
                           value="{{ old('center_uid') }}"
                           placeholder="e.g. BBA/CTR/2026/0001" required autofocus>
                </div>
                ...
                <button type="submit" class="btn-submit">
                    <i class="bi bi-box-arrow-in-right me-2"></i>Login to Center Portal
                </button>
            </form>
