...
<body style="margin:0;padding:24px;background:#f8fafc;font-family:Arial,sans-serif;color:#1e293b;">
    <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;">
        ...
        <div style="padding:24px;">
            ...
            <p style="color:#64748b;font-size:13px;">This OTP is valid for a limited time. If you did not request this, you can safely ignore this email — do not share the OTP with anyone.</p>
