                ...
                <tr>
                    <td style="padding:32px 40px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;margin-bottom:24px;overflow:hidden;">
                            ...
                            <tr>
                                <td style="padding:16px 24px;border-bottom:1px solid #e2e8f0;">
                                    <p style="margin:0;font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#64748b;font-weight:600;">Staff ID (use this to login)</p>
                                    <p style="margin:4px 0 0;font-size:15px;color:#1e293b;font-weight:600;font-family:'Courier New',monospace;">{{ $staffMember->staff_uid }}</p>
                                </td>
                            </tr>
                            <tr>
