...
<head>
    ...
    <title>Channel Partner Login</title>
    ...
    <style>
        ...
        .top-bar{height:4px;background:#854F0B;}
        .brand-circle{width:52px;height:52px;border-radius:50%;background:#854F0B20;display:flex;align-items:center;justify-content:center;font-size:22px;color:#854F0B;margin:0 auto 12px;}
        .form-control{border-radius:8px;height:44px;border:1.5px solid #e2e8f0;font-size:14px;}
        .form-control:focus{border-color:#854F0B;box-shadow:0 0 0 3px #854F0B25;}
        .btn-submit{height:46px;border-radius:8px;font-size:15px;font-weight:500;background:#854F0B;border:none;letter-spacing:.01em;transition:background .18s ease,box-shadow .18s ease,transform .15s ease;}
        .btn-submit:hover{background:#6b3f09;box-shadow:0 4px 14px rgba(133,79,11,.35);transform:translateY(-1px);}
...
<div class="card">
    ...
    <div class="p-4 p-md-5">
        ...
        <div class="text-center mb-4">
            <div class="brand-circle"><i class="bi bi-people"></i></div>
            <h5 class="fw-bold mb-1" style="color:#1e293b;">Channel Partner Login</h5>
            <p class="text-muted mb-0" style="font-size:13px;">Partner commission portal</p>
        </div>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('login') }}" class="back-link text-muted text-decoration-none">
