...
<head>
    ...
    <title>Channel Partner Login — Gaurangi Technologies</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        .form-control:focus{border-color:#854F0B;box-shadow:0 0 0 3px rgba(133,79,11,.12);background:#fff;outline:none;}
        ...
        .form-check-input:checked{background-color:#854F0B;border-color:#854F0B;}
        ...
        <div class="card-body-wrap">
            ...
            <form method="POST" action="{{ route('partner.login.submit') }}">
                ...
                <button type="submit" class="btn-submit">
                    <i class="bi bi-box-arrow-in-right me-2"></i>Login to Partner Portal
                </button>
            </form>
