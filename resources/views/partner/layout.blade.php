...
<div class="main-content">
    <div class="topbar mb-4 rounded shadow-sm">
        ...
        <div class="d-flex align-items-center gap-1 mx-2">
            @if($canAdmit && $authUser->canUseFullAdmissionForm())
            <a href="{{ route('partner.admissions.create') }}"
               class="btn btn-sm d-flex align-items-center gap-1 {{ request()->routeIs('partner.admissions.create') ? 'btn-primary' : 'btn-outline-primary' }}"
            ...
            @endif
            @if($canAdmit)
            <a href="{{ route('partner.admissions.quick-create') }}"
               class="btn btn-sm d-flex align-items-center gap-1 {{ request()->routeIs('partner.admissions.quick*') ? 'btn-warning' : 'btn-outline-warning' }}"
            ...
            @endif
            @if($authUser->canCollectFee())
            <a href="{{ route('partner.fee.create') }}"
               class="btn btn-sm d-flex align-items-center gap-1 {{ request()->routeIs('partner.fee.create') ? 'btn-success' : 'btn-outline-success' }}"
            ...
            @endif
            @if($canView)
            <a href="{{ route('partner.students.search') }}"
               class="btn btn-sm d-flex align-items-center gap-1 {{ request()->routeIs('partner.students.search') ? 'btn-info' : 'btn-outline-secondary' }}"
