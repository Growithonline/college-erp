...
@php
    ...
    $rPassedOut    = $_rp . 'passed-out-students';
    $rReadmit      = $_rp . 'readmit';
@endphp

<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="mb-0 fw-bold"><i class="bi bi-patch-check me-2 text-success"></i>Passed Out Students</h4>
        <small class="text-muted">Students who have fully completed the course</small>
    </div>
    <div class="d-flex gap-2">
        ...
        <a href="{{ route($rOutcomes) }}" class="btn btn-outline-dark btn-sm">
            <i class="bi bi-award me-1"></i> All Outcomes
        </a>
    ...
    <div class="card-body py-2">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="{{ route($rPassedOut) }}" class="btn btn-outline-secondary btn-sm">Clear</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-bottom py-2">
        <span class="fw-semibold small"><i class="bi bi-people me-2 text-success"></i>Students ({{ $students->total() }})</span>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="14" class="text-center py-5 text-muted">
                                <i class="bi bi-inboxes fs-2 d-block mb-2"></i>No passed out students found
                            </td>
                        </tr>
                    @endforelse
                </tbody>
