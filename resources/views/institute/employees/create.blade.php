                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-uppercase" name="license_no"
                                    value="{{ old('license_no') }}" placeholder="e.g. UP14 20110012345" maxlength="80">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-5 d-flex align-items-end">
                            <div class="alert alert-info py-2 px-3 mb-0 w-100" style="font-size:12px;">
                                ...
                                Save karne par ye employee automatically <strong>Transport → Drivers</strong> me appear ho jayega.
                            </div>
                        </div>
                    </div>
                </div>
