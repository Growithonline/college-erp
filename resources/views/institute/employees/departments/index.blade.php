...
@section('breadcrumb', 'Employees / Departments')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0">Employee Departments</h4>
        <p class="text-muted mb-0" style="font-size:13px;">Transport, Security, Housekeeping, etc.</p>
    </div>
    ...
    <div class="card-body p-0">
        ...
        <table class="table table-hover mb-0 align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4 fw-medium">{{ $dept->name }}</td>
                    <td><span class="badge text-bg-light text-dark border">{{ $dept->employees_count }}</span></td>
                    <td>
                        <span class="badge {{ $dept->status ? 'text-bg-success' : 'text-bg-secondary' }}">
                    ...
                    <td class="text-end pe-4">
                        ...
                        <form method="POST" action="{{ route('employees.departments.toggle', $dept) }}" class="d-inline">
                            @csrf
                            <button class="btn btn-sm {{ $dept->status ? 'btn-outline-warning' : 'btn-outline-success' }}">
        ...
        <div class="text-center py-5 text-muted">
            ...
            <p class="mb-3">No departments yet. Add Transport, Security, etc.</p>
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('employees.departments.store') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-semibold">Add Department</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <label class="form-label fw-medium">Department Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="name" required placeholder="e.g. Transport, Security">
                </div>
