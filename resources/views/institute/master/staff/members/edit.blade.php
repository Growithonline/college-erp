                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center gap-3">
                                <div class="form-check form-switch mb-0">
                                    ...
                                    <label class="form-check-label fw-semibold small" for="canManageNotices">
                                        <i class="bi bi-megaphone me-1 text-primary"></i>Notice Create/Manage karne ki permission
                                    </label>
                                </div>
