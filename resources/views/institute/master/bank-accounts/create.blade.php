                ...
                <form method="POST" action="{{ isset($bankAccount)
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">This label will be shown in dropdowns</div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">UPI ID linked to this bank account</div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 mt-3">
                        <div class="col-12">
                            <label class="form-label fw-semibold">
                                Allowed Payment Modes
                                <span class="text-muted fw-normal small ms-1">(accepted payment modes for this account)</span>
                            </label>
                            @php
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-1">
                                {{-- Cash always available - non-editable --}}
                                ...
                                <label class="border rounded px-3 py-2 d-flex align-items-center gap-2 cursor-pointer"
                                       style="cursor:pointer;user-select:none;"
                                       id="lbl-{{ $mode }}">
                                    <input type="checkbox"
                                           name="allowed_payment_modes[]"
                                           value="{{ $mode }}"
                                           class="form-check-input mt-0 mode-check"
                                           {{ in_array($mode, (array)$savedModes) ? 'checked' : '' }}
                                           onchange="updateModeLabel('{{ $mode }}')">
                            ...
                            <div class="form-text mt-1">
                                ...
                                Cash is always available on every account. Select additional modes here.
                            </div>
                        </div>
                    </div>
