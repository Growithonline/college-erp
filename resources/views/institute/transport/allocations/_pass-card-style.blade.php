/* Compact single-page institutional transport pass for DomPDF. */
@page { margin: 0; }
* { box-sizing: border-box; margin: 0; padding: 0; font-family: Helvetica, Arial, sans-serif; }
body { width: 243pt; }
.card { width: 243pt; padding: 4pt; border: 1pt solid #d8dde7; background: #ffffff; }
.pass-shell { width: 100%; border-collapse: collapse; table-layout: fixed; }

.brand-row td { height: 26pt; background: #a93631; vertical-align: middle; }
...
.brand-mark { width: 29pt; padding: 3pt 5pt 3pt 1pt; text-align: center; }
...
.identity-row td { padding-top: 4pt; vertical-align: top; }
...
.footer-row td { padding: 2pt 4pt; background: #eef0f3; vertical-align: middle; text-align: center; }
