...
.header-row td { background: #1746c9; padding: 3.5pt 6pt; vertical-align: middle; }
/* Seal sits on the right of the header (institute name on the left), matching a real
   institutional ID card's layout, so it takes the qr-cell's own column —
...
.info-rows td { font-size: 6.5pt; padding: 1.5pt 0; vertical-align: top; }
.info-rows td.rlabel { width: 26pt; color: #64748b; }
...
.footer-row td { padding-top: 3pt; }
.footer-table { width: 100%; border-collapse: collapse; }
.footer-table td { background: #eef1f5; padding: 2.5pt 6pt; text-align: center; vertical-align: top; }
...
.footer-rule { border-top: 1pt solid #cbd5e1; margin: 2pt 4pt 1.5pt; }
.footer-label {
    font-size: 4.5pt;
    font-weight: bold;
    color: #64748b;
