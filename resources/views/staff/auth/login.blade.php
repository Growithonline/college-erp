...
<head>
    ...
    <title>Staff Login — Gaurangi Technologies</title>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;}
        ...
        /* Card Header */
        .card-head{background:linear-gradient(135deg,#0a3d20 0%,#0f4c81 50%,#1D9E75 100%);padding:18px 28px 16px;position:relative;overflow:hidden;}
        ...
        .form-control:focus{border-color:#1D9E75;box-shadow:0 0 0 3px rgba(29,158,117,.12);background:#fff;outline:none;}
...
<div class="login-wrap">
    <div class="login-card">
        ...
        <div class="card-head">
            ...
            <div class="portal-icon"><i class="bi bi-person-workspace"></i></div>
            <h5>Staff Login</h5>
            <p>Verify password → receive OTP on email to complete login</p>
        </div>
        ...
        <div class="card-body-wrap">
            ...
            <form method="POST" action="{{ route('staff.login.submit') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="staff_uid"
                           class="form-control @error('staff_uid') is-invalid @enderror"
                           value="{{ old('staff_uid') }}"
                           placeholder="e.g. BBA/STF/2026/0001" required autofocus>
                </div>
