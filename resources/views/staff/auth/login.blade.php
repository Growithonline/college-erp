...
<head>
    ...
    <style>
        ...
        .brand-circle{width:52px;height:52px;border-radius:50%;background:#1D9E7520;display:flex;align-items:center;justify-content:center;font-size:22px;color:#1D9E75;margin:0 auto 12px;}
        ...
        .btn-submit{height:46px;border-radius:8px;font-size:15px;font-weight:500;background:#1D9E75;border:none;letter-spacing:.01em;transition:background .18s ease,box-shadow .18s ease,transform .15s ease;}
...
<div class="card">
    ...
    <div class="p-4 p-md-5">
        ...
        <div class="text-center mb-4">
            <div class="brand-circle"><i class="bi bi-person-badge"></i></div>
            <h5 class="fw-bold mb-1" style="color:#1e293b;">Staff Login</h5>
            <p class="text-muted mb-0" style="font-size:13px;">Password verify hone ke baad email OTP se login complete hoga</p>
        </div>
        ...
        <form method="POST" action="{{ route('staff.login.submit') }}">
            ...
            <button type="submit" class="btn btn-submit text-white w-100">
                <i class="bi bi-envelope-check me-2"></i>Send OTP
            </button>
        </form>
